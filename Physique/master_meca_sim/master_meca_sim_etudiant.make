...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/master_meca_sim_etudiant
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/master_meca_sim_etudiant
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/master_meca_sim_etudiant
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/master_meca_sim_etudiant
  DEFINES   += 
  INCLUDES  += -I.. -I../src/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/master_meca_sim_etudiant
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/master_meca_sim_etudiant
  DEFINES   += -DDEBUG
  INCLUDES  += -I.. -I../src/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/master_meca_sim_etudiant
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/master_meca_sim_etudiant
  DEFINES   += 
  INCLUDES  += -I.. -I../src/gKit
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking master_meca_sim_etudiant
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning master_meca_sim_etudiant
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/draw.o: ../src/gKit/draw.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main.o: src-etudiant/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Viewer.o: src-etudiant/Viewer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Viewer-init.o: src-etudiant/Viewer-init.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/MSS.o: src-etudiant/MSS.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Scene.o: src-etudiant/Scene.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ObjetSimule.o: src-etudiant/ObjetSimule.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ObjetSimuleMSS.o: src-etudiant/ObjetSimuleMSS.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/ObjetSimuleParticule.o: src-etudiant/ObjetSimuleParticule.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Properties.o: src-etudiant/Properties.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Param.o: src-etudiant/Param.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Calculs.o: src-etudiant/Calculs.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/CalculsMSS.o: src-etudiant/CalculsMSS.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/CalculsParticule.o: src-etudiant/CalculsParticule.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
